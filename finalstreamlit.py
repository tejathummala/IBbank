...
folder_path1 = r"C:\Users\CGSPL\Desktop\IB Reports\IB Reports"
...
if os.path.exists(file_path):
    ...
    with tab2:
            ...
            plt.title('Unique Merchants Count per MEMBER_ID', fontsize=14)
    ...
    with tab4:
            ...
            top_reasons = reason_counts[reason_counts > 10]
